...
void rk4Step(Ray& ray, double dλ, double rs) {
    ...
    if (r3.r <= rs) {
        ray.r    += (dλ / 3.0) * (k1[0] + 2 * k2[0]);
        ray.phi  += (dλ / 3.0) * (k1[1] + 2 * k2[1]);
        ray.dr   += (dλ / 3.0) * (k1[2] + 2 * k2[2]);
        ray.dphi += (dλ / 3.0) * (k1[3] + 2 * k2[3]);
        return;
    }
    ...
    if (r4.r <= rs) {
        ray.r    += (dλ / 5.0) * (k1[0] + 2 * k2[0] + 2 * k3[0]);
        ray.phi  += (dλ / 5.0) * (k1[1] + 2 * k2[1] + 2 * k3[1]);
        ray.dr   += (dλ / 5.0) * (k1[2] + 2 * k2[2] + 2 * k3[2]);
        ray.dphi += (dλ / 5.0) * (k1[3] + 2 * k2[3] + 2 * k3[3]);
        return;
    }
